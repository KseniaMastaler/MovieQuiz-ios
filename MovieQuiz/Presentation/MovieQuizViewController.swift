...
final class MovieQuizViewController: UIViewController {
    ...
    @IBAction private func yesButtonClicked(_ sender: UIButton) {
        ...
        showAnswerResult(isCorrect: current.correctAnswer)
    }
...
private extension UIFont {
    static let ysDisplayMedium20 = UIFont(name: "YS Display Medium", size: 20) ?? .systemFont(ofSize: 20, weight: .medium)
    static let ysDisplayBold23 = UIFont(name: "YS Display Bold", size: 23) ?? .systemFont(ofSize: 23, weight: .bold)
}
